...
const NITC = "National Institute of Technology, Calicut"; 
...
function SignUpForm() {
    ...
    // Event handler for when the signup button is clicked FOR TECHERS
    ...
    // Fetching teachers directly as School is now fixed to NITC
    if(teachersSelect.length === 0) {
        API.getTeachersBySchool(NITC)
        .then(res => {
            // console.log("KYA HUA BHAI", res);
            ...
            <form className="uk-form-stacked uk-position-relative teacherForm" uk-height-viewport="expand: true">
                <div className="uk-margin">
                    ...
                    <div className="uk-form-controls">
                        <input className="uk-input uk-form-width-medium" id="email" type="text" placeholder="" ref={emailRef} />
                    </div>
                </div>
                <div className="uk-margin">
                ...
                <div className="uk-margin">
                    ...
                    <div className="uk-form-controls">
                        <input className="uk-input uk-form-width-medium" id="name" type="text" placeholder="" ref={nameRef} />
                    </div>
                </div>
                <div className="uk-margin">
                    <label className="uk-form-label uk-text">Subject Code</label>
                    <div className="uk-form-controls">
                        <input className="uk-input uk-form-width-medium" id="subject" type="text" placeholder="" ref={subjectRef} />
                    </div>
                </div>
                <hr />
        ...
        return (
            <form className="uk-form-stacked uk-position-relative studentForm" uk-height-viewport="expand: true">
                <div className="uk-margin">
                    <label className="uk-form-label uk-text">Email</label>
                    <div className="uk-form-controls">
                        <input className="uk-input uk-form-width-medium stuInput" id="email" type="text" placeholder="" ref={emailRef} />
                    </div>
                </div>
                <div className="uk-margin">
                    <label className="uk-form-label uk-text">Password</label>
                ...
                <div className="uk-margin">
                    <label className="uk-form-label uk-text">Name</label>
                    <div className="uk-form-controls">
                        <input className="uk-input uk-form-width-medium stuInput" id="name" type="text" placeholder="" ref={nameRef} />
                    </div>
                </div>
                <hr />
                {/* <div className="uk-margin uk-flex uk-flex-bottom">
                ...
                <div className="uk-margin">
                    <label className="uk-form-label">Subjects</label>
                    <div className="uk-grid-small uk-child-width-auto uk-grid" >
                        {
                            teachersSelect.length > 0 ? (
                                teachersSelect.map(teacher =>
                                    <label key={teacher._id}><input name={teacher._id} className="uk-checkbox" type="checkbox" onChange={handleCheckbox} /> {teacher.subject}</label>
                                )
                            ) : <p className="noTeacherText">Loading...</p>
                        }
                    </div>
                </div>
                <div className="uk-flex uk-flex-column uk-flex-middle">
